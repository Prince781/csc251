...
`define ISSUE_QUEUE_ENTRY_BITS (5 + /* ROB entry No. */ + 32 /* instr */ + 32 /* PC */ + 6 /* ALU op */ + 1 /* has immediate? */ + 32 /* immediate */ + `PROJ_LOG_PHYS /* src1 reg */ + 1 /* src1 ready? */ + `PROJ_LOG_PHYS /* src2 */ + 1 /* src2 ready? */ + 5 /* shift amount */ + 1 /* regwrite? */ +  `PROJ_LOG_PHYS /* dest */ + 1 /* memwrite? */ + 32 /* memwritedata */ + 1 /* memread? */)
